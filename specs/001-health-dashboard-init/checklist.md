...
- [x] CHK008 `npx tsc --noEmit` exits with code 0 (zero type errors)
...
- [ ] CHK018 Production Vercel build succeeds (`vercel --prod` or GitHub integration) ⬅ **blocks merge**
- [ ] CHK019 Vercel function logs show upload completing in < 10 seconds for the 32-row sample CSV ⬅ **blocks merge**
